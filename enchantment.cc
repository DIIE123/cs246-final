...
// Enchantment
Enchantment::Enchantment(std::string enchantmentName, int cost, std::string attackString, std::string defenseString, std::shared_ptr<Card> minion, Player& p):
    Minion{minion->getName(), p}, enchantmentName{enchantmentName}, enchantmentCost{cost}, attackString{attackString}, 
      defenseString{defenseString}, enchantmentDesc{enchantmentDesc}, minion{minion} {}

Enchantment::Enchantment(std::string enchantmentName, int cost, std::string enchantmentDesc, std::shared_ptr<Card> minion, Player& p):
    Minion{minion->getName(), p}, enchantmentName{enchantmentName}, enchantmentCost{cost}, enchantmentDesc{enchantmentDesc}, minion{minion} {}
...
// Giant Strength
GiantStrength::GiantStrength(std::shared_ptr<Card> minion, Player& p): Enchantment{"Giant Strength", 1, "+2", "+2", minion, p} {}
...
// Enrage
Enrage::Enrage(std::shared_ptr<Card> minion, Player& p): Enchantment{"Enrage", 2, "*2", "*2", minion, p} {}
...
// Haste
Haste::Haste(std::shared_ptr<Card> minion, Player& p): Enchantment{"Haste", 1, "Enchanted minion gains +1 action each turn.", minion, p} {}
Haste::~Haste() = default;
...
// Magic Fatigue
MagicFatigue::MagicFatigue(std::shared_ptr<Card> minion, Player& p): Enchantment{"Magic Fatigue", 0, "Enchanted minion's activated ability costs 2 more.", minion, p} {}
...
// Silence
Silence::Silence(std::shared_ptr<Card> minion, Player& p): Enchantment{"Silence", 1, "Enchanted minion cannot use abilities.", minion, p} {}
