...
// Enchantment
Enchantment::Enchantment(std::string enchantmentName, size_t cost, std::string attackString, std::string defenseString, std::unique_ptr<Minion> minion):
...
Enchantment::Enchantment(std::string enchantmentName, size_t cost, std::string abilityDesc, std::unique_ptr<Minion> minion):
...
Haste::~Haste() = default;
size_t Haste::getMaxActions() { return minion->getMaxActions() + 1; }
...
size_t MagicFatigue::getAbilityCost() { return minion->getAbilityCost() + 2; }
